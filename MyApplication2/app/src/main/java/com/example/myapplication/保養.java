...
public class 保養 extends AppCompatActivity implements CustomAdapter.OnScooterListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scooter_fix);
        ...
        //建立ArrayList及資料庫物件
        myDB = new DatabaseManage(保養.this);
        ...
        customAdapter = new CustomAdapter(保養.this, Scooter_id, Scooter_Name, Scooter_License, Scooter_Model, Scooter_Manufacture_Date, this);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(保養.this));
    }
    ...
    public void Show_All_My_Scooter() {
        ...
        if(cursor.getCount() == 0){
            Toast.makeText(this,"請先在車庫新增愛車再使用【保養】功能", Toast.LENGTH_SHORT).show();
    ...
    public void OnScooterClick(int position) {
        Intent intent = new Intent(this, 查詢保養紀錄.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.recommend_fix_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            ...
            intent.setClass(保養.this, MainActivity.class);
            startActivity(intent);
        }
        //選單按鈕的觸發事件，intent到【建議保養里程表】頁面
        if (item.getItemId() == R.id.recommend_fix) {
            Intent intent = new Intent();
            intent.setClass(保養.this, 建議保養里程表.class);
            startActivity(intent);
        }
